...
public class DomainController extends Common {
    ...
    @ResponseBody
    public Map<String, Object> getDomains(@PathVariable String status, HttpServletResponse response, HttpServletRequest request) {

        return domainService.getDomains("/domains-admin/" + status, HttpMethod.GET, null,response,request);
    }

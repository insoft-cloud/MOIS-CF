...
public class DomainService {
     ...
     */
    public Map<String, Object> getDomains(String reqUrl, HttpMethod httpMethod, Object obj, HttpServletResponse response, HttpServletRequest request) {
        return commonService.procApiRestTemplate(V3_URL + reqUrl, httpMethod, obj, Constants.CF_API);
    }

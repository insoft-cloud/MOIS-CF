...
public class AuthorityManagementService {
     ...
     */
    public Map<?, Object> getAuthorityGroups(String reqUrl, HttpMethod httpMethod, String param) throws Exception {
        return commonService.procApiRestTemplate(Constants.V3_URL + reqUrl, httpMethod, param,Constants.CF_API);
    }
    ...
    public Map<String, Object> getUaaUserInfo(String reqUrl, HttpMethod httpMethod, Map param) throws Exception {
        return commonService.procApiRestTemplate(Constants.V2_URL + reqUrl, httpMethod, param,Constants.CF_API);
    }

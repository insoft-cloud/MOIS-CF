...
//    }
    ...
    public Map<String, Object> getOrgsForAdmin(String reqUrl, HttpMethod httpMethod, Object obj, HttpServletResponse response, HttpServletRequest request) throws Exception {
        return commonService.procApiRestTemplate(Constants.V3_URL + reqUrl, httpMethod, obj,Constants.CF_API);
    }

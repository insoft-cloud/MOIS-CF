...
public class ClientController  extends Common {
    ...
    public Map<String, Object> getClientList() throws Exception {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/clients", HttpMethod.GET, null,Constants.CF_API);
    }
    ...
    public Map<String, Object> getClient(@PathVariable String clientId) throws Exception {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/clients/"+clientId, HttpMethod.GET, null,Constants.CF_API);
    }
    ...
    public Map<String, Object> registerClient(@RequestBody Map<String, Object> param) throws Exception {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/clients", HttpMethod.POST, param,Constants.CF_API);
    }
    ...
    public Map<String, Object> updateClient(@RequestBody Map<String, Object> param) throws Exception {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/clients", HttpMethod.PUT, param,Constants.CF_API);
    }
    ...
    public Map<String, Object> deleteClient(@PathVariable String clientId) throws Exception {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/clients/" + clientId, HttpMethod.DELETE, null,Constants.CF_API);
    }

...
public class ServiceBrokerController extends Common {
    ...
    public Map<String, Object> getServiceBrokers(@ModelAttribute ServiceBroker serviceBroker) {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/servicebrokers", HttpMethod.GET, serviceBroker,Constants.CF_API);
    }
    ...
    public Map<String, Object> getServiceBroker(@ModelAttribute ServiceBroker serviceBroker, @PathVariable String guid) {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/servicebrokers/" + guid, HttpMethod.GET, serviceBroker,Constants.CF_API);
    }
    ...
    public Map<String, Object> createServiceBroker(@RequestBody ServiceBroker serviceBroker) {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/servicebrokers", HttpMethod.POST, serviceBroker,Constants.CF_API);
    }
    ...
    public Map<String, Object> updateServiceBroker(@RequestBody ServiceBroker serviceBroker, @PathVariable String guid) {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/servicebrokers/" + guid, HttpMethod.PUT, serviceBroker,Constants.CF_API);
    }
    ...
    public Map<String, Object> deleteServiceBroker(@PathVariable String guid, @RequestParam boolean purge) {
        return commonService.procApiRestTemplate(Constants.V2_URL + "/servicebrokers/"+guid+"?purge="+purge, HttpMethod.DELETE, null,Constants.CF_API);
    }

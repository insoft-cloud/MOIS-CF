...
public class QuotaManagementController extends Common {
    ...
    public Map<String, Object> getOrgQuotaDefinitions(@ModelAttribute Quota quota) {
       return commonService.procApiRestTemplate(Constants.V3_URL + "/orgs/quota-definitions", HttpMethod.GET, quota,Constants.CF_API);
    }
    ...
    public Map<String, Object> getOrgQuotaDefinition(@ModelAttribute Quota quota, @PathVariable String quotaId) {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/orgs/quota-definitions/"+quotaId, HttpMethod.GET, quota,Constants.CF_API);
    }
    ...
    public Map<String, Object> createOrgQuotaDefinition(@RequestBody Quota quota) {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/orgs/quota-definitions", HttpMethod.POST, quota,Constants.CF_API);
    }
    ...
    public Map<String, Object> updateOrgQuotaDefinition(@RequestBody Quota quota, @PathVariable String quotaId) {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/orgs/quota-definitions/"+quotaId, HttpMethod.PUT, quota,Constants.CF_API);
    }
    ...
    public Map<String, Object> deleteOrgQuotaDefinition(@PathVariable String quotaId) {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/orgs/quota-definitions/"+quotaId, HttpMethod.DELETE, null,Constants.CF_API);
    }
    ...
    public Map<String, Object> getSpaceQuotaDefinitions(@ModelAttribute Quota quota) {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/spaces/quota-definitions", HttpMethod.GET, quota,Constants.CF_API);
    }
    ...
    public Map<String, Object> getSpaceQuotaDefinition(@ModelAttribute Quota quota, @PathVariable String spaceQuotaId) {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/spaces/quota-definitions/"+spaceQuotaId, HttpMethod.GET, quota,Constants.CF_API);
    }
    ...
    public Map<String, Object> createSpaceQuotaDefinition(@RequestBody Quota quota) {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/spaces/quota-definitions", HttpMethod.POST, quota,Constants.CF_API);
    }
    ...
    public Map<String, Object> updateSpaceQuotaDefinition(@RequestBody Quota quota, @PathVariable String spaceQuotaId) {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/spaces/quota-definitions/"+spaceQuotaId, HttpMethod.PUT, quota,Constants.CF_API);
    }
    ...
    public Map<String, Object> deleteSpaceQuotaDefinition(@PathVariable String quotaId) {
        return commonService.procApiRestTemplate( Constants.V3_URL + "/spaces/quota-definitions/"+quotaId, HttpMethod.DELETE, null,Constants.CF_API);
    }

...
public class ServicePlansController extends Common {
    ...
    public Map<String, Object> getCatalogService() throws Exception {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/catalogs/serviceplan-admin", HttpMethod.GET, null,Constants.CF_API);
    }
    ...
    public Map<String, Object> getServicePlans() {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/serviceplans", HttpMethod.GET, null,Constants.CF_API);
    }
    ...
    public Map<String, Object> getServicePlan(@ModelAttribute ServiceBroker serviceBroker, @PathVariable String guid) {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/serviceplans/" + guid, HttpMethod.GET, serviceBroker,Constants.CF_API);
    }
    ...
    public Map<String, Object> updateServicePlan(@RequestBody ServiceBroker serviceBroker, @PathVariable String guid) {
        ...
        return commonService.procApiRestTemplate(Constants.V3_URL + "/serviceplans/" + guid, HttpMethod.PUT, serviceBroker,Constants.CF_API);
    }
    ...
    public Map<String, Object> getServicePlanVisibilites(@PathVariable String serviceplanId) {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/serviceplans/" + serviceplanId + "/visibilites", HttpMethod.GET, null,Constants.CF_API);
    }
    ...
    public Map<String, Object> updateServicePlanVisibility(@RequestBody Map param, @PathVariable String guid) throws Exception {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/serviceplanvisibilities/" + guid, HttpMethod.PUT, param,Constants.CF_API);
    }
    ...
    public Map<String, Object> deleteServicePlanVisibility(@PathVariable String guid) throws Exception {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/serviceplanvisibilities/" + guid, HttpMethod.DELETE, null,Constants.CF_API);
    }
    ...
    public Map<String, Object> deleteAllServicePlanVisibility(@PathVariable String guid) throws Exception {
        return commonService.procApiRestTemplate(Constants.V3_URL + "/serviceplanvisibilities/all/" + guid, HttpMethod.DELETE, null,Constants.CF_API);
    }

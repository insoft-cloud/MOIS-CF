...
export class DashboardComponent implements OnInit,  AfterViewChecked{
  ...
  constructor(private translate: TranslateService, private commonService: CommonService, private dashboardService: DashboardService, private log: NGXLogger,
              private appMainService: AppMainService, private catalogService: CatalogService, private route: ActivatedRoute, private router: Router, private http: HttpClient, private keycloakService:KeycloakService) {
  ...
  SERVICE_SIZE(){
    if(isNullOrUndefined(this.servicesEntities) || isNullOrUndefined(this.servicesEntities.length)){
      return 0;
    }
    return this.servicesEntities.length;
  }

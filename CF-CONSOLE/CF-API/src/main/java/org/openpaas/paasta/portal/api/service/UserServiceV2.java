...
import org.openpaas.paasta.portal.api.rabbitmq.util.JsonUtils;
...
public class UserServiceV2 extends Common {
    ...
    public UserServiceV2(CommonService commonService, LoginServiceV1 loginServiceV1, RestTemplate restTemplate) {
     ...
     * @return 삭제 정보
     */
    public Object allUsers(String start) {
        try {
            LOGGER.info("allUsers ::: ");
            List<Object> totalResource = new LinkedList<>();
            return commonService.procUAARestTemplate("/Users?startIndex="+start, HttpMethod.GET, null, uaaAdminToken(connectionContext(), adminUserName, adminPassword, uaaAdminClientId, uaaAdminClientSecret), Map.class);
        } catch (Exception e) {

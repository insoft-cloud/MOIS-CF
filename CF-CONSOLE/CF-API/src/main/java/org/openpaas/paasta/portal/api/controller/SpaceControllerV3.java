...
public class SpaceControllerV3 extends Common {
    ...
    public GetSpaceSummaryResponse getSpaceSummaryAdmin(@PathVariable String spaceid) throws Exception {

        GetSpaceSummaryResponse respSapceSummary = spaceServiceV3.getAdminSpaceSummary(spaceid);
        return respSapceSummary;
    }

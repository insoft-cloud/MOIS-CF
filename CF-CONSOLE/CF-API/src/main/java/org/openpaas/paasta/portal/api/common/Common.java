...
public class Common {
     ...
     * @return ReactorUaaClient
     */
    public String uaaAdminToken(ConnectionContext connectionContext, String adminUserName, String adminPassword, String uaaAdminClientId, String uaaAdminClientSecret) {
        ReactorUaaClient reactorUaaClient = uaaClient(connectionContext, tokenProvider());
        GetTokenByClientCredentialsResponse getTokenByClientCredentialsResponse = reactorUaaClient.tokens().getByClientCredentials(GetTokenByClientCredentialsRequest.builder().clientId(uaaAdminClientId).clientSecret(uaaAdminClientSecret).build()).block();
        return getTokenByClientCredentialsResponse.getTokenType() + " " + getTokenByClientCredentialsResponse.getAccessToken();
    }
    ...
    public PasswordGrantTokenProvider tokenProvider(String username, String password, String clientId, String clientSecret) {
        return PasswordGrantTokenProvider.builder().password(password).username(username).clientId(clientId).clientSecret(clientSecret).build();
    }

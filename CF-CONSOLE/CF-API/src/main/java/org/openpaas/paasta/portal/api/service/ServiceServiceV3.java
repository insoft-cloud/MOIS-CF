...
public class ServiceServiceV3 extends Common {
    ...
    private Map parsing(String str) throws IOException {

        HashMap<String, Object> returnMap = new ObjectMapper().readValue(str, HashMap.class) ;
    ...
    public Map updateUserProvided(String guid, String token, Service service) throws Exception {
        ...
        HashMap result = new HashMap();
        Map<String, Object> map = new HashMap<>();
        LOGGER.info(service.getCredentials());
        try {
            //Todo credentialsStr parsing => map

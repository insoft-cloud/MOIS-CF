package org.openpaas.paasta.portal.api.rabbitmq.util;
...
import org.openpaas.paasta.portal.api.rabbitmq.exception.ServiceBrokerException;
...
public class JsonUtils {
    ...
    public static List<Object> getListFromJsonStr(Object object) throws ServiceBrokerException {
        ObjectMapper objectMapper = new ObjectMapper();
        try {

            Gson gson = new Gson();
            return gson.fromJson(objectMapper.writeValueAsString(object),List.class);

            //return objectMapper.readValue(, List.class);
        } catch (JsonParseException var4) {
            throw new ServiceBrokerException(getSwitchedMessage(1));
        } catch (JsonMappingException var5) {
            throw new ServiceBrokerException(getSwitchedMessage(2));

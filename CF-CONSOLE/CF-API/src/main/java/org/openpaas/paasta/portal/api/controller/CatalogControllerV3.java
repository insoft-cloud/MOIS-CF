...
public class CatalogControllerV3 extends Common {
     ...
     * @throws Exception Exception(자바클래스)
     */
    @PostMapping(Constants.V3_URL + "/catalogs/serviceinstance")
     ...
     * @param param
     * @param token String(자바클래스)
     * @return CreateServiceInstanceResponse (자바클래스)
     * @throws Exception Exception(자바클래스)
     */
    ...
    @PostMapping(Constants.V3_URL + "/service_instance")
    public CreateServiceInstanceResponse CreateServcieInstance(@RequestBody ServiceInstanceProvisionRequest param, @RequestHeader(AUTHORIZATION_HEADER_KEY) String token) throws Exception {
        LOGGER.info(param.toString());
        return catalogServiceV3.CreateServcieInstance(param, cloudFoundryClient(connectionContext(), tokenProvider(token)));
    }
    ...
    @PutMapping(Constants.V3_URL + "/services/{instance_id}")
    public UpdateServiceInstanceResponse updateServicePlan(@PathVariable String instance_id, @RequestBody ServiceInstanceProvisionRequest param, @RequestHeader(AUTHORIZATION_HEADER_KEY) String token) throws Exception {
        return catalogServiceV3.updateServicePlan(instance_id, param, cloudFoundryClient(connectionContext(), tokenProvider(token)));
    }
}
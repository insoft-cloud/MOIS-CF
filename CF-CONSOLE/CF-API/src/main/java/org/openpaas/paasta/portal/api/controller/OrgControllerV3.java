...
public class OrgControllerV3 extends Common {
    ...
    public Map getOrgSummaryAdmin(@PathVariable String orgId, @RequestHeader(AUTHORIZATION_HEADER_KEY) String token) {
        return orgServiceV3.adminGetOrgSummaryMap(orgId);
    }
     ...
     * @return ListOrganizationsResponse
     */
    @GetMapping(Constants.V3_URL + "/orgs-admins/{org_id}")
    public GetOrganizationResponse getOrgForAdmin(@PathVariable String org_id) {
        return orgServiceV3.getOrg(org_id, cloudFoundryClient());
    }

...
public class UserControllerV3 extends Common {
    ...
    @PostMapping(Constants.V3_URL + "/user/keycloak")
    public Map KeycloakUser(@RequestBody MoisUser user) throws Exception {
        return userServiceV3.KeycloakUser(user);
    }

    @PostMapping(Constants.V3_URL + "/user/cfpw")
    public Map CF_PW(@RequestBody MoisUser user) throws Exception {
        return userServiceV3.CF_PW(user);
    }

...
public class CommonService {
    ...
    public void procCfApiRestTemplate2(String reqUrl, HttpMethod httpMethod, Object obj, String reqToken) {
        String cfRequestURL = cfApiUrl + "/v3/" ;
        restTemplate = new RestTemplate();
        HttpHeaders reqHeaders = new HttpHeaders();
        reqHeaders.add(AUTHORIZATION_HEADER_KEY, base64Authorization);
        ...
        HttpEntity<Object> reqEntity = new HttpEntity<>(obj, reqHeaders);
        LOGGER.info("cfApiUrl::" + cfRequestURL + reqUrl);
        restTemplate.exchange(cfRequestURL + reqUrl, httpMethod, reqEntity, Object.class);
    }

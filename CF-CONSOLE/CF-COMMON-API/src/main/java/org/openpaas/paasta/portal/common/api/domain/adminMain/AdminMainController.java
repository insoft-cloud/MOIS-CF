...
public class AdminMainController {
    ...
    @GetMapping(value = {V2_URL + "/statistics/{guid}"})
    public Map<String, Object> getTotalCountList(@PathVariable String guid) {
        return adminMainService.getTotalCountList(guid);
    }
    ...
    @GetMapping(value = {V2_URL + "/statistics/organizations/{guid}"})
    public Map<String, Object> getTotalOrganizationList(@PathVariable String guid) {
        return adminMainService.getTotalOrganizationList(guid);
    }

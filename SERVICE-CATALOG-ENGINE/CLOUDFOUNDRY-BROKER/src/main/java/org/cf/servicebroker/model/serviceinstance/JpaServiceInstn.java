...
public class JpaServiceInstn {
    ...
    @JsonSerialize
    @JsonProperty("virtl_mchn_instn_id")
    @Column(name = "virtl_mchn_instn_id", length = 128)
    private String vmInstnId;

    @JsonSerialize
    @JsonProperty("wdtb_nm")
    @Column(name = "wdtb_nm", length = 128)
    private String dtbNm;
